...
model_formula_2 <- "log10_SalePrice ~ log10_GrLivArea + OverallQual + LotArea + HouseStyle + Neighborhood + SaleCondition + Condition1 + OverallCond + YearBuilt + CentralAir + Fireplaces + WoodDeckSF" %>%
  as.formula()
